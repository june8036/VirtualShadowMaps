...
namespace VirtualTexture
{
    ...
    public class VirtualLightMaps : MonoBehaviour
    {
        /// <summary>
        /// Feedback材质
        /// </summary>
        ...
        /// </summary>
        [Space(10)]
        public VirtualLightMapData lightData;
        ...
        public void OnEnable()
        {
            ...
            foreach (var cam in SceneView.GetAllSceneCameras())
            {
                ...
                {
                    if (cam.gameObject.TryGetComponent<VirtualLightMapCamera>(out var virtualLightMapCamera))
                        virtualLightMapCamera.enabled = true;
                    else
                        cam.gameObject.AddComponent<VirtualLightMapCamera>();
                }
            }
#endif

            VirtualLightMapsManager.instance.Register(this);
        }
        ...
        public void OnDisable()
        {
            ...
            VirtualLightMapsManager.instance.Unregister(this);
        }
        ...
        public void Refresh()
        {
            foreach (var cam in SceneView.GetAllSceneCameras())
            {
                ...
                {
                    if (cam.gameObject.TryGetComponent<VirtualLightMapCamera>(out var virtualLightMapCamera))
                        virtualLightMapCamera.ResetLightMaps();
                }
            }
        }
#endif
        ...
        public Texture2D GetTexture()
        {
            if (LightmapSettings.lightmaps.Length == 1)
                return LightmapSettings.lightmaps[0].lightmapColor;
